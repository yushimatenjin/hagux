!(function (e,t) {
    'object' === typeof exports && 'undefined' !== typeof module ? t(exports) : 'function' === typeof define && define.amd ? define(['exports'],t) : t((e = e || self).Redux = {});
}(this,function (e) {
    'use strict';var t = (function (e) {
        var t; var r = e.Symbol;return 'function' === typeof r ? r.observable ? t = r.observable : (t = r('observable'),r.observable = t) : t = '@@observable',t;
    }('undefined' !== typeof self ? self : 'undefined' !== typeof window ? window : 'undefined' !== typeof global ? global : 'undefined' !== typeof module ? module : Function('return this')())); var r = function () {
        return Math.random().toString(36).substring(7).split('').join('.');
    }; var n = { INIT:'@@redux/INIT' + r(),REPLACE:'@@redux/REPLACE' + r(),PROBE_UNKNOWN_ACTION:function () {
        return '@@redux/PROBE_UNKNOWN_ACTION' + r();
    } };function o (e,t) {
        var r = t && t.type;return 'Given ' + (r && 'action "' + r + '"' || 'an action') + ', reducer "' + e + '" returned undefined. To ignore an action, you must explicitly return the previous state. If you want this reducer to hold no value, you can return null instead of undefined.';
    } function i (e,t) {
        return function () {
        ...
        var r = Object.keys(e);return Object.getOwnPropertySymbols && r.push.apply(r,Object.getOwnPropertySymbols(e)),t && (r = r.filter(function (t) {
            return Object.getOwnPropertyDescriptor(e,t).enumerable;
        })),r;
    } function a (e) {
        for (var t = 1;arguments.length > t;t++) {
            var r = null != arguments[t] ? arguments[t] : {};t % 2 ? c(r,!0).forEach(function (t) {
                u(e,t,r[t]);
        ...
        for (var e = arguments.length,t = Array(e),r = 0;e > r;r++) {
            ...
            return function () {
                var r = e.apply(void 0,arguments); var n = function () {
                ...
                }; var o = { getState:r.getState,dispatch:function () {
        ...
        if ('function' === typeof e) {
            ...
            var o = e[n];'function' === typeof o && (r[n] = i(o,t));
        } return r;
    },e.combineReducers = function (e) {
        for (var t = Object.keys(e),r = {},i = 0;t.length > i;i++) {
            var u = t[i];'function' === typeof e[u] && (r[u] = e[u]);
        } var c; var a = Object.keys(r);try {
            !(function (e) {
                Object.keys(e).forEach(function (t) {
                    var r = e[t];if (void 0 === r(void 0,{ type:n.INIT })) {
            ...
            if (void 0 === e && (e = {}),c) {
                ...
                var f = a[u]; var s = e[f]; var d = (0,r[f])(s,t);if (void 0 === d) {
                    var l = o(f,t);throw Error(l);
                }i[f] = d,n = n || d !== s;
            } return (n = n || a.length !== Object.keys(e).length) ? i : e;
        };
    },e.compose = f,e.createStore = function e (r,o,i) {
        var u;if ('function' === typeof o && 'function' === typeof i || 'function' === typeof i && 'function' === typeof arguments[3]) {
        ...
        } var c = r; var a = o; var f = []; var s = f; var d = !1;function l () {
            s === f && (s = f.slice());
        } function p () {
            if (d) {
            ...
            } var t = !0;return l(),s.push(e),function () {
                if (t) {
                    if (d) {
            ...
            if (!(function (e) {
                ...
                d = !1;
            } for (var t = f = s,r = 0;t.length > r;r++) {
                (0,t[r])();
            } return e;
        } return y({ type:n.INIT }),(u = { dispatch:y,subscribe:h,getState:p,replaceReducer:function (e) {
            if ('function' !== typeof e) {
                throw Error('Expected the nextReducer to be a function.');
            }c = e,y({ type:n.REPLACE });
        } })[t] = function () {
            var e; var r = h;return (e = { subscribe:function (e) {
                if ('object' !== typeof e || null === e) {
